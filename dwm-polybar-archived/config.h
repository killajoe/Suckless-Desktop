...
static const Rule rules[] = {
    ...
    { "Alacritty",    NULL,       NULL,               1 << 1,      	1,			 0,           0,          0,          -1 },
    { "ncmpcpp",   	  NULL,       NULL,               1 << 3,     	1,			 0,           0,          0,          -1 },
	...
	{ NULL,       	  NULL,   "scratchpad",	          0,			0,			 1,           1,          0,          -1 },
};
...
//	{ MODKEY,                       XK_Tab,    view,           {0} },
	...
	{ MODKEY|ShiftMask,             XK_t,      setlayout,      {.v = &layouts[0]} }, /* Dwindle */
	{ MODKEY|ShiftMask,	            XK_f,      setlayout,      {.v = &layouts[1]} }, /* Null */
	{ MODKEY|ControlMask,           XK_f,      setlayout,      {.v = &layouts[2]} }, /* Spiral */
	{ MODKEY,                       XK_g,      setlayout,      {.v = &layouts[3]} }, /* Gapless Grid */
	{ MODKEY,                       XK_r,      setlayout,      {.v = &layouts[3]} }, /* Gapless Grid */
